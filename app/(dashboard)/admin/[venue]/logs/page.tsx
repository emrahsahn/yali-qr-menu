...
export default function AdminVenueLogsPage({ params }: PageProps) {
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2 border-b border-border">
          ...
          <div className="flex items-center gap-2 text-xs font-bold text-foreground/60 flex-wrap">
            ...
            <ChevronRight className="h-3.5 w-3.5 text-foreground/30" />
            <span className="text-primary font-black">Eylem Günlüğü</span>
          </div>
        ...
        {/* Audit Log Viewer for this venue */}
        <AuditLogViewer venue={venue} />
      </div>
    </StaffProvider>
  )
}
